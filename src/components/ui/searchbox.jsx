...
const Search = () => {
  ...
  return (
    <div >
      ...
      <input
        className="w-full  p-2 bg-gray-200 dark:bg-black  text-black dark:text-white focus:outline-none "
        type="text"
        placeholder="Search..."
      ...
      <button
        onClick={onSearch}
        className=" w-auto bg-gray-300 dark:bg-gray-900 flex justify-end items-center  focus:outline-none p-2 "
      >
        <svg
